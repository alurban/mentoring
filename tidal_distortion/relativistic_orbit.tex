...
\item If the collision is completely inelastic (so that the masses stick together), use the conservation of 4-momentum to write down the final energy and momentum in terms of the mass ratio $m_1/m_2$.
\end{enumerate}
