...
\caption{\label{fig:trace} Traces of the four closed orbits I simulated on a polar diagram. Note that when you use too high a step size during elliptical orbits, the perihelion advances clockwise around the orbital plane. This is unphysical behavior that is actually impossible in Keplerian orbits. The circular orbit is at a radius $a_L \approx 20$ km.}
\end{figure}
