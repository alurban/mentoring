...
\caption{\label{fig:binary_diagram}Diagram of the neutron star binary, showing its orbital separation vector ($\mathbf{a}$) and the radius ($R$) and masses ($M$) of the individual neutron stars. The azimuthal angle $\varphi$ is also indicated. Note, this orbit will stay confined to the $xy$-plane.}
\end{mdframed}
\end{figure}
